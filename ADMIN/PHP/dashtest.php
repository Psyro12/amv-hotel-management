...
if ($isMobile || $isAndroidTablet) {
    // 🟢 CLEAR EXCLUSIVE ACCESS: Clear last_activity so the session doesn't "lock" login.php
...
$sql_list = "SELECT 
    ...
    WHERE (b.check_out >= CURDATE() OR b.arrival_status = 'in_house')
...
// 🟢 FIX: Update the ORDER BY list to remove 'pending' since we filtered them out
$sql_list .= " GROUP BY b.id ORDER BY FIELD(b.status, 'confirmed', 'cancelled'), b.check_in ASC";
...
<head>
    ...
    <style>
        ...
        html {
            scrollbar-gutter: stable; /* 🟢 Reserve space for scrollbar to prevent jumping */
        }

        body {
            height: 100%;
            margin: 0;
            overflow-y: scroll; /* 🟢 Force scrollbar to stay visible for consistency */
        }
        ...
        .main-content {
            ...
            min-width: 0; /* Prevents flex children from stretching parent */
            overflow: visible;
        }
        ...
        .page-content {
            ...
            flex-direction: column;
            overflow: visible;
            max-width: none; /* 🟢 Remove 1400px limit from dashboard-styles.css */
        }
        ...
        @media (min-width: 1025px) {
            #settings.page {
                overflow: hidden !important; /* Prevent main settings page from scrolling */
                height: 100%;
            }
            #settings .settings-view {
                max-height: 100%;
                overflow-y: auto; /* Allow internal view to scroll if needed */
            }
            #settings-home {
                overflow-y: auto;
            }
        ...
        .modal-content-calendar {
            ...
            width: 90%;
            max-width: 480px;
            /* Slimmer, more mobile-like width */
            margin: auto;
            overflow: hidden;
            position: relative;
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
                            ...
                            <div class="dropdown-header"
                                ...
                                <div
                                    ...
                                    <div style="display:flex; gap: 8px;">
                                        <button class="filter-btn" style="color: #2563EB; font-size: 0.7rem;" onclick="markAllMessagesRead(event)">
            ...
            <div id="newNotificationAlert" class="new-booking-alert" style="display: none; border-left-color: #3B82F6;">
                ...
                <div class="toast-progress-container"><div class="toast-progress-bar" style="background: #3B82F6;"></div></div>
            </div>
            ...
            <div id="newMessageAlert" class="new-booking-alert" style="display: none; border-left-color: #10B981;">
                ...
                <button class="nb-action-btn" style="background:none; border:1px solid #eee; color:#9CA3AF; padding: 6px 10px;" onclick="markAllMessagesRead(event)">Mark All</button>
                <div class="toast-progress-container"><div class="toast-progress-bar" style="background: #10B981;"></div></div>
            </div>
            ...
            z-index: 999;">
                ...
                <div class="toast-progress-container"><div class="toast-progress-bar" style="background: #F59E0B;"></div></div>
            </div>
            ...
            <div id="newOrderAlert" class="new-booking-alert" style="display: none; border-left-color: #7E22CE;">
                ...
                <div class="toast-progress-container"><div class="toast-progress-bar" style="background: #7E22CE;"></div></div>
            </div>
            ...
            <div class="page-content">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div
                            ...
                            <div style="width: 200px;">
                                <select id="dashboardMonthPicker" class="ab-select" onchange="toggleMonthInput(this.value); fetchDashboardCards()">
                    ...
                    <div class="charts-grid charts-grid-dashboard">
                        ...
                        <div class="chart-card"
                            ...
                            <div
                                ...
                                <button class="cal-btn" onclick="changeChartYear(-1)" title="Previous Year"
                                    style="background:none; border:none; cursor:pointer; font-size:1.2rem; color:#555;">
                                    ◀
                                </button>
                                ...
                                <button class="cal-btn" onclick="changeChartYear(1)" title="Next Year"
                                    style="background:none; border:none; cursor:pointer; font-size:1.2rem; color:#555;">
                                    ▶
                                </button>
                            </div>
                    ...
                    <div class="p-3">
                        ...
                        <div id="settings-home" class="settings-view">
                            ...
                            <div class="settings-tree-grid">
                                ...
                                <div class="tree-item-card" onclick="openSettingsView('view-about-us')">
                                    <div class="tree-icon">
                ...
                <div id="view-profile" class="settings-view pp-container">
                    ...
                    <div class="pp-fixed-header">
                        <button class="back-btn-settings" onclick="openSettingsView('settings-home')">⬅ Back</button>
                            ...
                            <tbody id="roomTableBody">
                                <?php foreach ($allRoomsDB as $room): ?>
                                    ...
                                    <tr id="room-row-<?php echo $room['id']; ?>" class="<?php echo $rowClass; ?>"
                                        ...
                                        <td>
                                            <div class="room-name" style="font-weight: 600; font-size: 1rem; color: #333;">
                                                <?php echo $room['name']; ?>
                                                <?php if ($isActive == 0): ?>
                                                    <span
                ...
                <div id="view-news" class="settings-view px-3 mb-3">
                    ...
                    <div class="booking-table-container">
                        ...
                        '<?php echo $news['image_path']; ?>')">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="5" class="text-center" style="padding:30px;">No news posted yet.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    ...
                    <div class="booking-table-container">
                        <table class="booking-table">
                            ...
                            '<?php echo $food['image_path']; ?>'
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" class="text-center" style="padding:30px; color:#888;">No menu items
                                            found.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                ...
                <div id="view-privacy" class="settings-view px-3 mb-3">
                    ...
                    <div class="settings-content">
                        <div class="settings-section flex-card p-3"
                            ...
                            <div class="settings-title-area">
                                <p style="font-size:0.9rem; color:#666; margin-bottom:15px;">
                                    Define how user data is handled. Changes reflect immediately on the Privacy Policy
                                    page.
                                </p>
                            </div>
                ...
                <div id="view-events" class="settings-view px-3 mb-3">
                    <div class="settings-header" style="justify-content: space-between;">
                        ...
                        <div style="display:flex; gap: 10px;">
                            <button class="btn-secondary" id="toggleArchivedEventsBtn" onclick="toggleArchivedEvents()">
                                Show Archived
                            </button>
                    ...
                    <div class="booking-table-container">
                        <table class="booking-table">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="5" class="text-center" style="padding:30px;">No events scheduled.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                ...
                <div id="view-receipts" class="settings-view px-3 mb-3">
                    ...
                    <div class="receipt-gallery-container" style="min-height: 400px; max-height: 75vh; overflow-y: auto; padding: 5px;">
                            ...
                            <tbody>
                                <?php foreach ($all_amenities as $am): ?>
                                    <tr style="vertical-align: middle;">
                                        ...
                                        <td style="font-weight: 600; color: #333;"><?php echo htmlspecialchars($am['title']); ?></td>
                                        <td style="color: #666; font-size: 0.85rem;"><?php echo htmlspecialchars($am['description']); ?></td>
                                        <td>
                                            <button class="btn-secondary" style="padding:6px 12px; margin-right: 5px;"
                                            ...
                                            <button class="btn-secondary" style="padding:6px 12px; color: #EF4444; border-color: #FCA5A5;"
                ...
                <!-- About Us Content Editor View -->
                <div id="view-about-us" class="settings-view px-3 mb-3">
                    <div class="settings-header">
                        <button class="back-btn-settings" onclick="openSettingsView('settings-home')">⬅ Back</button>
                        <h3 class="m-0">About Us Interactive Editor</h3>
                    </div>

                    <div class="settings-content" style="max-width: 1100px; margin: 20px auto;">
                        <div class="pp-card" style="flex-direction: column; padding: 0; overflow: hidden; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.08);">
                            
                            <!-- Tab Navigation -->
                            <div class="about-tabs-nav">
                                <button type="button" class="about-tab-btn active" onclick="switchAboutTab(event, 'tab-welcome')">
                                    <i class="fas fa-home"></i> Welcome Info
                                </button>
                                <button type="button" class="about-tab-btn" onclick="switchAboutTab(event, 'tab-experience')">
                                    <i class="fas fa-star"></i> Experience
                                </button>
                                <button type="button" class="about-tab-btn" onclick="switchAboutTab(event, 'tab-services')">
                                    <i class="fas fa-concierge-bell"></i> Services & Features
                                </button>
                                <button type="button" class="about-tab-btn" onclick="switchAboutTab(event, 'tab-location')">
                                    <i class="fas fa-map-marker-alt"></i> Location
                                </button>
                            </div>

                            <form id="aboutUsForm" onsubmit="saveAboutUsContent(event)" enctype="multipart/form-data" style="padding: 30px;">
                                
                                <!-- Tab: Welcome Info -->
                                <div id="tab-welcome" class="about-tab-content active">
                                    <div class="section-hint mb-4">
                                        <i class="fas fa-lightbulb"></i>
                                        Update the main introductory text guests see when they first visit the About Us page.
                                    </div>
                                    <div class="ab-mb-4">
                                        <label class="rm-label">Main Headline</label>
                                        <input type="text" class="rm-input" name="gem_title" id="about_gem_title" placeholder="e.g. The Gem of Mamburao">
                                    </div>
                                    <div class="ab-mb-4">
                                        <div class="text-counter-wrapper">
                                            <label class="rm-label">About Content</label>
                                            <textarea class="rm-input" name="gem_p1" id="about_gem_p1" rows="12" oninput="updateWordCount(this)" placeholder="Enter one or more paragraphs here. Separate paragraphs with an empty line."></textarea>
                                            <small class="word-count">Words: 0</small>
                                        </div>
                                        <input type="hidden" name="gem_p2" id="about_gem_p2">
                                    </div>
                                </div>
                                ...
                                <div id="tab-experience" class="about-tab-content">
                                    <div class="section-hint mb-4">
                                        ...
                                        Manage your signature hotel experiences. Upload high-quality photos to attract guests.
                                    </div>
                                    <div class="ab-mb-4">
                                        <label class="rm-label">Section Header</label>
                                        <input type="text" class="rm-input" name="sig_title" id="about_sig_title" placeholder="e.g. Signature Experience">
                                    </div>
                                    
                                    <div class="experience-card mb-4">
                                        <div class="exp-img-preview">
                                            <img id="prev_sig_relax_img" src="../../IMG/room_1.jpg">
                                            <label class="img-upload-overlay">
                                                <i class="fas fa-cloud-upload-alt"></i> Change Photo
                                                <input type="file" name="sig_relax_img_file" style="display:none;" onchange="previewAboutImage(this, 'prev_sig_relax_img')">
                                            </label>
                                        </div>
                                        <div class="exp-details">
                                            <input type="hidden" name="sig_relax_img" id="about_sig_relax_img">
                                            <label class="rm-label">Feature 1 Title</label>
                                            <input type="text" class="rm-input mb-3" name="sig_relax_h3" id="about_sig_relax_h3">
                                            <label class="rm-label">Description</label>
                                            <textarea class="rm-input" name="sig_relax_p" id="about_sig_relax_p" rows="3"></textarea>
                                        </div>
                                    </div>

                                    <div class="experience-card">
                                        <div class="exp-img-preview">
                                            <img id="prev_sig_dining_img" src="../../IMG/food_7.jpg">
                                            <label class="img-upload-overlay">
                                                <i class="fas fa-cloud-upload-alt"></i> Change Photo
                                                <input type="file" name="sig_dining_img_file" style="display:none;" onchange="previewAboutImage(this, 'prev_sig_dining_img')">
                                            </label>
                                        </div>
                                        <div class="exp-details">
                                            <input type="hidden" name="sig_dining_img" id="about_sig_dining_img">
                                            <label class="rm-label">Feature 2 Title</label>
                                            <input type="text" class="rm-input mb-3" name="sig_dining_h3" id="about_sig_dining_h3">
                                            <label class="rm-label">Description</label>
                                            <textarea class="rm-input" name="sig_dining_p" id="about_sig_dining_p" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>

                                <!-- Tab: Services -->
                                <div id="tab-services" class="about-tab-content">
                                    <div class="info-alert mb-4">
                                        <strong><i class="fas fa-info-circle"></i> Tip:</strong> Use FontAwesome classes like <code>fa-wifi</code> or <code>fa-car</code>. 
                                        <a href="https://fontawesome.com/v6/search?o=r&m=free" target="_blank" style="margin-left:10px; color:#B45309;">Open Library <i class="fas fa-external-link-alt fa-xs"></i></a>
                                    </div>
                                    
                                    <div class="ab-grid-2">
                                        <div class="list-editor-container">
                                            <div class="list-editor-header">
                                                <span><i class="fas fa-concierge-bell"></i> Hotel Services</span>
                                                <button type="button" class="add-item-btn" onclick="addAboutListItem('services')">+ Add</button>
                                            </div>
                                            <div id="services-list-admin" class="about-dynamic-list"></div>
                                            <input type="hidden" name="hotel_services" id="about_hotel_services">
                                        </div>

                                        <div class="list-editor-container">
                                            <div class="list-editor-header">
                                                <span><i class="fas fa-bed"></i> Room Features</span>
                                                <button type="button" class="add-item-btn" onclick="addAboutListItem('features')">+ Add</button>
                                            </div>
                                            <div id="features-list-admin" class="about-dynamic-list"></div>
                                            <input type="hidden" name="room_features" id="about_room_features">
                                        </div>
                                    </div>
                                </div>

                                <!-- Tab: Location -->
                                <div id="tab-location" class="about-tab-content">
                                    <div class="section-hint mb-4">
                                        <i class="fas fa-map-marked-alt"></i>
                                        Provide the exact physical address of the hotel. This will be displayed in the "Visit Us" section.
                                    </div>
                                    
                                    <div class="location-editor-card">
                                        <div class="location-icon-side">
                                            <div class="map-icon-circle">
                                                <i class="fas fa-map-location-dot"></i>
                                            </div>
                                            <div class="map-line"></div>
                                        </div>
                                        <div class="location-form-side">
                                            <label class="rm-label">Official Hotel Address</label>
                                            <textarea class="rm-input" name="visit_address" id="about_visit_address" rows="4" 
                                                placeholder="e.g. Mamburao, Occidental Mindoro, Philippines"
                                                style="resize: none; font-size: 1rem; line-height: 1.6;"></textarea>
                                            <div class="mt-3 d-flex align-center gap-2" style="color: #64748b; font-size: 0.85rem;">
                                                <i class="fas fa-info-circle"></i>
                                                <span>Tip: Include landmarks to help guests find you easily.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="about-form-footer">
                                    <p class="m-0 text-muted" style="font-size: 0.85rem;">
                                        <i class="fas fa-history"></i> Changes are saved instantly to the system.
                                    </p>
                ...
                <style>
                    ...
                    .about-tab-btn i { font-size: 1.1rem; }
                    .about-tab-btn:hover { color: #2563eb; background: #eff6ff; }
                    ...
                    .about-tab-content { display: none; animation: fadeIn 0.4s ease; }
                    ...
                    .experience-card:hover { border-color: #2563eb; box-shadow: 0 4px 12px rgba(37,99,235,0.1); }
                    ...
                    .exp-img-preview img { width: 100%; height: 100%; object-fit: cover; }
                    .img-upload-overlay {
                        position: absolute;
                    ...
                    .exp-img-preview:hover .img-upload-overlay { opacity: 1; }
                    ...
                    .about-dynamic-list { max-height: 350px; overflow-y: auto; padding: 10px; background: #fff; }
                    
                    .text-counter-wrapper { position: relative; }
                    .word-count {
                        position: absolute;
                        right: 10px;
                        bottom: -20px;
                    ...
                    .save-all-btn:hover { transform: translateY(-2px); box-shadow: 0 6px 15px rgba(37,99,235,0.3); }
                    ...
                    .about-list-item {
                        display: grid;
                        grid-template-columns: 40px 120px 1fr 30px;
                        gap: 8px;
                        margin-bottom: 8px;
                        background: #fff;
                        padding: 8px;
                    ...
                    .about-list-item .icon-preview-box {
                        width: 32px;
                        height: 32px;
                        background: #f8fafc;
                        border-radius: 6px;
                    ...
                    .about-list-item input:focus {
                        border-color: #2563eb !important;
                        outline: none;
                        box-shadow: 0 0 0 2px rgba(37,99,235,0.1);
                    }
                    .about-list-item .remove-item {
                        color: #94a3b8;
                        cursor: pointer;
                        text-align: center;
                        font-size: 1.1rem;
                    ...
                    .about-list-item .remove-item:hover {
                        color: #ef4444;
                        transform: scale(1.1);
                    }
                </style>
                    ...
                    <div id="ab-step-3" class="ab-step">
                        ...
                        <div class="ab-grid-2 ab-mb-3">
                            <div>
                                ...
                                <input type="text" class="ab-input" name="contact" placeholder="+63-901-2345678"
                                    required oninput="this.value = this.value.replace(/[^0-9]/g, '')" maxlength="11">
                            </div>
        ...
        <div class="ab-modal-content" style="max-width: 500px; height: auto; max-height: 90vh;">
            ...
            <div class="ab-modal-body" style="padding: 20px;">
                <div
                    ...
                    <div style="display:flex; justify-content:space-between; margin-bottom:10px;">
                        <span style="color:#888; font-size:0.8rem; font-weight:700;">ROOMS</span>
                        <span style="font-weight:600; color:#333;" id="ba_room"></span>
                    </div>
                    <div style="display:flex; justify-content:space-between; margin-bottom:10px;">
            ...
            <div class="ab-modal-body" style="padding: 25px;">
                <form id="roomForm" enctype="multipart/form-data">
                    ...
                    <div class="ab-mb-4">
                        ...
                        <div id="amenitiesGrid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(150px, 1fr)); gap: 10px; background: #f9f9f9; padding: 15px; border-radius: 8px; border: 1px solid #eee;">
                            <?php foreach ($all_amenities as $am): ?>
                                <label style="display: flex; align-items: center; gap: 8px; font-size: 0.85rem; cursor: pointer; color: #555;">
                                    <input type="checkbox" name="amenities[]" value="<?php echo $am['id']; ?>" class="am-checkbox">
                                    <i class="<?php echo htmlspecialchars($am['icon_class']); ?>" style="width: 16px; text-align: center;"></i>
    ...
    <div id="amenityModal" class="modal" style="z-index: 1500;">
        <div class="ab-modal-content" style="max-width: 500px;">
            <div class="ab-modal-header">
                ...
                <button class="ab-close-btn" onclick="document.getElementById('amenityModal').style.display='none'">✕</button>
            </div>
            <div class="ab-modal-body" style="padding: 25px;">
                <form id="amenityForm">
                    ...
                    <div class="ab-mb-3">
                        ...
                        <input type="text" class="rm-input" name="title" id="amenityTitleInput" required placeholder="e.g. Swimming Pool">
                    </div>

                    <div class="ab-mb-3">
                        <label class="rm-label">Icon Class (FontAwesome)</label>
                        <div style="display:flex; gap:10px; align-items:center;">
                            <input type="text" class="rm-input" name="icon_class" id="amenityIconInput" required placeholder="e.g. fas fa-swimming-pool" oninput="previewAmenityIcon(this.value)">
                            <div id="amenityIconPreview" style="font-size: 1.5rem; color: #B88E2F; width: 40px; text-align:center;">
                                <i class="fas fa-question-circle"></i>
                            </div>
                        </div>
                        <div style="background: #f8f9fa; border: 1px solid #e9ecef; border-radius: 6px; padding: 10px; margin-top: 10px;">
                            ...
                            <ol style="margin: 0; padding-left: 20px; font-size: 0.75rem; color: #666;">
                                <li>Go to <a href="https://fontawesome.com/v5/search?m=free" target="_blank" style="color: #B88E2F; font-weight: 700; text-decoration: underline;">FontAwesome 5 Free Icons</a></li>
                                <li>Search for your desired icon (e.g. "wifi", "tv", "coffee").</li>
                                <li>Copy the class name (e.g. <b>fas fa-wifi</b>) and paste it here.</li>
                            </ol>
                            <small style="display: block; margin-top: 8px; font-size: 0.7rem; color: #888; font-style: italic;">
                    ...
                    <div class="ab-mb-4">
                        <label class="rm-label">Description</label>
                        <textarea class="rm-input" name="description" id="amenityDescInput" rows="3" placeholder="Brief details about this amenity..."></textarea>
                    </div>
    ...
    <div id="extendModal" class="modal" style="z-index: 1600;">
        <div class="ab-modal-content" style="max-width: 400px; height: auto;">
            ...
            <div class="ab-modal-body" style="padding: 25px;">
                ...
                <!-- 🟢 PRICE PREVIEW BOX -->
                <div id="ext_price_preview" style="margin-top: 20px; padding: 15px; background: #F9FAFB; border: 1px solid #E5E7EB; border-radius: 8px; display: none;">
                    ...
                    <div style="display: flex; justify-content: space-between; font-size: 0.85rem; color: #666; margin-bottom: 8px;">
                        <span>Extra Nights:</span>
                        <span id="ext_extra_nights">0</span>
                    </div>
                    <div style="display: flex; justify-content: space-between; font-size: 1rem; font-weight: 700; color: #333; border-top: 1px dashed #ccc; padding-top: 8px;">
            ...
            <div class="ab-modal-body" style="padding: 30px;">
                <form id="adminEditForm" onsubmit="saveAdminProfile(event)">
                    ...
                    <div class="edit-row-1" style="margin-bottom: 20px;">
                        ...
                        <input type="text" class="edit-input" name="contact" id="edit_contact" placeholder="+63...">
                    </div>
    ...
    <div id="rescheduleModal" class="modal" style="z-index: 1700;">
        <div class="ab-modal-content" style="max-width: 450px; height: auto;">
            ...
            <div class="ab-modal-body" style="padding: 25px;">
                ...
                <div class="ab-grid-2 ab-mb-3">
                    ...
                    <div>
                        ...
                        <div class="ab-input-wrapper">
                            <input type="text" id="resched_checkout" class="ab-input" placeholder="Select Date" readonly>
                            <i class="far fa-calendar-alt ab-calendar-icon"></i>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        // ✅ UPDATED REVENUE CHART CONFIG (LINE GRAPH) ✅
        ...
        // --- GLOBAL VARIABLES ---
        let isProcessingBooking = false; // 🔴 ADD THIS FLAG
        let currentChartYear = new Date().getFullYear(); // Start with 2025 (or current year)
        let isDrawerBusy = false;
        let isSendingEmail = false;

        // --- 1. CHARTS RENDERING ---
        window.myBookingPieChart = null; // 🔴 Declare Global Variable
        ...
        function changeChartYear(offset) {
            currentChartYear += offset; // +1 or -1
            fetchRevenueChart(currentChartYear);
        }

        // --- 3. FETCH CHART DATA ONLY ---
        function fetchRevenueChart(year) {
            // Update Title immediately
            document.getElementById('revenueChartTitle').innerText = "Revenue " + year;
        ...
        // --- 4. RENDER CHART (LINE GRAPH VERSION) ---
        function renderRevenueChart(dataValues) {
            const container = document.getElementById('barChartContainer');
            const oldCanvas = document.getElementById('barMonthly');
            if (oldCanvas) oldCanvas.remove(); // Delete old

            const newCanvas = document.createElement('canvas');
            newCanvas.id = 'barMonthly';
            container.appendChild(newCanvas); // Add new
        ...
        function filterTable(filterType) {
            ...
            // 2. SORT THE ROWS FIRST
            sortBookingRows(filterType);

            // 3. THEN APPLY VISIBILITY
            applyBookingFilters();
        }

        // 🔴 NEW FUNCTION: Sorts rows differently based on the active tab
        function sortBookingRows(filterType) {
            const tbody = document.getElementById('bookingTableBody');
            const rows = Array.from(tbody.querySelectorAll('.booking-row'));

            rows.sort((a, b) => {
                if (filterType === 'recent') {
                    // --- RECENT TAB: Sort by Created Date (Newest Top) ---
                    const dateA = new Date(a.getAttribute('data-created'));
                    const dateB = new Date(b.getAttribute('data-created'));
                    return dateB - dateA; // Descending (Newest first)
                } else {
                    // --- OTHER TABS: Sort by Status -> Check-in (Standard) ---

                    // 1. Status Priority (Pending > Confirmed > Cancelled)
                    const statusMap = { 'pending': 1, 'confirmed': 2, 'cancelled': 3, 'no_show': 4, 'checked_out': 5 };
                    const statA = statusMap[a.getAttribute('data-status')] || 99;
                    const statB = statusMap[b.getAttribute('data-status')] || 99;

                    if (statA !== statB) return statA - statB;

                    // 2. Check-in Date (Earliest first)
                    const checkinA = new Date(a.getAttribute('data-checkin'));
                    const checkinB = new Date(b.getAttribute('data-checkin'));
                    return checkinA - checkinB;
                }
            });

            // Re-append rows to the table in the new order
            rows.forEach(row => tbody.appendChild(row));
        }

        // Helper: Check if date is strictly today (YYYY-MM-DD)
        ...
        // Helper: Check if booking was created in the last 72 hours (3 Days)
        function isRecent(createdDateString) {
            if (!createdDateString) return false; // Safety check

            // 🔴 FIX: Replace space with 'T' to ensure all browsers parse it correctly
            // Converts "2025-01-11 14:00:00" to "2025-01-11T14:00:00"
            const safeDateString = createdDateString.replace(' ', 'T');
            ...
            if (isNaN(createdDate.getTime())) {
                console.warn("Invalid date found:", createdDateString);
                return false;
            }
            ...
            return diffHours <= 72; // True if within 3 days
        }
        ...
        function applyBookingFilters() {
            ...
            rows.forEach(row => {
                ...
                const rowArrival = row.getAttribute('data-arrival');

                // Text Search
                const refText = row.cells[0].innerText.toLowerCase();
                const nameText = row.cells[1].innerText.toLowerCase();
                const matchesSearch = (refText.includes(filter) || nameText.includes(filter));
                ...
                else if (currentTabStatus === 'today') {
                    matchesTab = isToday(rowCheckIn);
                }
                else if (currentTabStatus === 'recent') {
                    matchesTab = isRecent(rowCreated);
                }
                // 🟢 FIX: Add Logic for "Late" (Review Button)
                else if (currentTabStatus === 'late') {
                    // Logic: 
                    // 1. Check-in must be TODAY
                    // 2. Status must be 'confirmed'
                    // 3. Arrival status must NOT be 'in_house', 'checked_out', or 'no_show'
                    const isDateToday = isToday(rowCheckIn);
                    const isConfirmed = rowStatus === 'confirmed';
                    const isPending = !['in_house', 'checked_out', 'no_show', 'cancelled'].includes(rowArrival);

                    matchesTab = (isDateToday && isConfirmed && isPending);
                }
            ...
            if (visibleCount === 0) {
                ...
                if (currentTabStatus === 'today') noDataMsg.innerText = "No bookings scheduled for today.";
                else if (currentTabStatus === 'recent') noDataMsg.innerText = "No new bookings in the last 3 days.";
                else if (currentTabStatus === 'late') noDataMsg.innerText = "No pending arrivals found for today."; // Custom message
                else noDataMsg.innerText = "No bookings found.";
            } else {
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (searchInput) {
                searchInput.addEventListener('keyup', applyBookingFilters);
            }
        });

        // 3. Attach Search Event Listener
        document.addEventListener("DOMContentLoaded", function () {
        ...
        document.getElementById('finalConfirmBtn').onclick = function () {
            ...
            // 🔴 THIS PART WAS MISSING IN YOUR CODE - PASTE THIS:
            if (cancelBtn) {
        ...
        // Updated signature to accept 'bookingSource' at the end
        function openBookingAction(id, name, ref, rooms, checkin, checkout, price, arrivalStatus, amountPaid, currentLabel, createdAt, bookingSource, dailyPrice = 0) {
        ...
        function updateStatus(id, action, isAuto = false, btnElement = null) {
            ...
            // 2. LOCK UI (Set the Global Flag)
            isProcessingBooking = true; // 🔴 LOCK ACTIVATED
            ...
            fetch('update_arrival.php', {
                    ...
                    if (data.status === 'success') {
                        ...
                        if (!isAuto) {
                            ...
                            setTimeout(() => {
                                ...
                                // The modal will be closed manually by the user or code below, 
                                // but we must unlock first.
                                document.getElementById('bookingActionModal').style.display = 'none';
                            }, 100);
                        }
                ...
                .finally(() => {
                    // 🔴 UNLOCK UI (Must run regardless of success/error)
        ...
        function filterGuestTable() {
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                // Get Name (Column 0) and Email (Column 1)
                // We use check both so you can search by email too
            ...
            const noDataMsg = document.getElementById('noGuestDataMessage');
    ...
    `;
        ...
        // Initialize Flatpickr for the notification filter
        document.addEventListener("DOMContentLoaded", function () {
            flatpickr("#notifDateFilter", {
                dateFormat: "Y-m-d",
                // static: true, // Keeps calendar inside the flow if possible
                onChange: function (selectedDates, dateStr, instance) {
                    currentNotifDate = dateStr;
                    filterAndRender(); // Trigger filter when date changes
                }
            });
        });
    ...
    <div class="dropdown-item-row" style="${bgStyle}" 
        ...
        function filterAndRenderMessages() {
            ...
            if (currentMsgFilter === 'all') {
                filteredList = window.allMessages;
            }
            else if (currentMsgFilter === 'unread') {
                filteredList = window.allMessages.filter(m => m.is_read == 0);
            }
        ...
        function openExtendModal(id, currentCheckout) {
            ...
            // 4. FIX: Close calendar if user scrolls the modal (prevents floating ghost calendar)
            const modalBody = document.querySelector('#extendModal .ab-modal-body');
            if (modalBody) {
                modalBody.onscroll = function () {
                    if (extendPickerInstance && extendPickerInstance.isOpen) {
                        extendPickerInstance.close();
                    }
                };
            }
        }
        ...
        function closeExtendModal() {
            ...
            // Re-open the main booking action modal in case they cancelled
            // (Optional, remove if you prefer it to just close everything)
            // document.getElementById('bookingActionModal').style.display = 'block'; 
        }
        ...
        function submitExtension() {
            ...
            if (!confirm(`Confirm extension until ${newDate}?`)) return;
        ...
        `;
            ...
            // 5. Re-apply the current filter (e.g., if you are on "Today" tab)
            applyBookingFilters();
        }
        ...
        function fetchGuestList() {
            // 1. If user is searching, skip update to prevent UI jumping
            const searchInput = document.getElementById('guestSearchInput');
            if (searchInput && searchInput.value.trim() !== "") {
                return;
            }

            fetch('get_all_guests.php')
                .then(res => res.json())
                .then(data => {
                    if (data.status === 'success') {
    ...
    <tr class="guest-row">
       ...
       <td style="text-align: center;">
        ...
        <td>
            ...
            // Check if we need to re-apply the filter (double check)
            filterGuestTable();
        }
    ...
    `;
        ...
        function refreshBookingTable() {
            // 1. Don't refresh if user is currently typing in the search box
            const searchInput = document.getElementById('bookingSearchInput');
            if (searchInput && searchInput.value.trim() !== "") {
                return;
            }
            ...
            fetch('fetch_booking_table.php?t=' + new Date().getTime())
                .then(response => response.text())
                .then(html => {
                    const tbody = document.getElementById('bookingTableBody');
                    if (!tbody) return;

                    // 3. Update the table content (This resets the order to default)
                    tbody.innerHTML = html;

                    // 🟢 FIX: Re-Sort the rows immediately based on the active tab!
                    // This forces "Recent" order to stay even after refresh
                    if (typeof sortBookingRows === 'function') {
                        sortBookingRows(currentTabStatus);
                    }

                    // 4. Re-apply visibility filters (Show/Hide)
        ...
        function refreshFoodTable() {
            // Only run if the table exists on screen
            const tbody = document.getElementById('foodTableBody');
            if (!tbody) return;

            fetch('fetch_food_table.php?t=' + new Date().getTime())
                .then(res => res.text())
                .then(html => {
                    tbody.innerHTML = html;
    ...
    `;
        ...
        // ==========================================
        // 🟢 UPDATED TRANSACTION PAGE LOGIC
        // ==========================================

        // 1. Main Load Function (Updated for Real-time)
        function loadTransactions(isSilent = false) {
            ...
            // 🟢 ONLY show spinner if NOT in silent mode (Manual Refresh)
            if (!isSilent) {
                tbody.innerHTML = '<tr><td colspan="8" style="text-align:center; padding:30px; color:#888;"><i class="fas fa-spinner fa-spin"></i> Refreshing history...</td></tr>';
            }
            ...
            fetch('get_transactions.php')
                ...
                .then(response => {
                    if (response.status === 'success') {
                        // If silent mode, we only update; user won't notice a flash
        ...
        // 2. Render Function (Updated with Click Event)
        function renderTransactionTable(data, filter) {
            ...
            filteredData.forEach(t => {
                ...
                // 🟢 NEW: Add Click Event & Style
                tr.style.cursor = 'pointer';
                tr.className = 'transaction-row'; // For hover effect

                // Store full object in a way we can pass it (Closure)
        ...
        function sendGuestEmail(e) {
            ...
            fetch('send_guest_email.php', {
                ...
                .finally(() => {
                    // 2. UNLOCK UI (Only runs if there was an error or we didn't close the modal)
                    isSendingEmail = false;
        ...
        // ---------------------------------------------------------------
        // 🟢 REAL-TIME SNAPSHOT LISTENER (SSE Implementation)
        // ---------------------------------------------------------------
        // This replaces the old 1s/2s polling intervals with a persistent connection.
        // It's like Firebase: The UI only refreshes when the database actually changes.

        const setupSSE = () => {
            const sse = new EventSource('sse_updates.php');

            sse.addEventListener('update', (event) => {
                const categories = JSON.parse(event.data);
                console.log("🔔 Real-time Update Received:", categories);

                categories.forEach(cat => {
                    switch(cat) {
                        case 'bookings':
                            if (document.getElementById('bookings').classList.contains('active')) refreshBookingTable();
                            if (document.getElementById('calendar').classList.contains('active')) refreshCalendarData();
                            fetchDashboardCards();
                            fetchPendingBookings();
                            fetchHeaderData();
                            break;
                        case 'food_orders':
                            if (document.getElementById('food-ordered').classList.contains('active')) {
                                const drawerOpen = document.getElementById('orderDrawer').classList.contains('open');
                                if (!drawerOpen) refreshFoodTable();
                            }
                            fetchDashboardCards();
                            fetchPendingOrders();
                            fetchHeaderData();
                            break;
                        case 'transactions':
                            if (document.getElementById('transactions').classList.contains('active')) loadTransactions(true);
                            fetchDashboardCards();
                            break;
                        case 'notifications':
                        case 'messages':
                        ...
                        case 'rooms':
                            ...
                            break;
                        case 'guests':
                            if (document.getElementById('guests').classList.contains('active')) fetchGuestList();
                            break;
                    }
                });
            });
        ...
        // ---------------------------------------------------------------
        // 🟡 REMOVED POLLING (Replaced by SSE above)
        // ---------------------------------------------------------------
        /*
        ...
        */
        ...
        // ---------------------------------------------------------------
        // 🟢 PERSISTENT BACKGROUND TASKS (Time-dependent, NOT data-dependent)
        // ---------------------------------------------------------------
 ...
 */
        ...
        // --- ABOUT US CONTENT LOGIC ---
        function switchAboutTab(evt, tabId) {
        ...
        function updateWordCount(textarea) {
            const wrapper = textarea.closest('.text-counter-wrapper');
            if (!wrapper) return;
        ...
        function addAboutListItem(type, icon = 'fa-check', label = '') {
            const containerId = type === 'services' ? 'services-list-admin' : 'features-list-admin';
            ...
            // Clean icon name (some might paste the whole <i> tag)
            let cleanIcon = icon;
            if (icon.includes('class="')) {
                const match = icon.match(/class="([^"]+)"/);
                if (match) cleanIcon = match[1].replace('fas ', '').replace('fa-solid ', '');
            }

            item.innerHTML = `
                <div class="icon-preview-box"><i class="fas ${cleanIcon}"></i></div>
                <input type="text" placeholder="Icon Class" value="${cleanIcon}" class="item-icon" oninput="updateAboutIconPreview(this)">
                <input type="text" placeholder="Service/Feature Label" value="${label}" class="item-label">
                <div class="remove-item" onclick="this.parentElement.remove()" title="Remove Item"><i class="fas fa-times-circle"></i></div>
            `;
            container.appendChild(item);
        }

        function updateAboutIconPreview(input) {
            const previewBox = input.parentElement.querySelector('.icon-preview-box i');
            let iconClass = input.value.trim();
            
            // Auto-prefix with fa- if missing and not empty
            if (iconClass !== "" && !iconClass.startsWith('fa-')) {
                // We don't change the input value, just the preview
                previewBox.className = 'fas fa-' + iconClass;
            } else {
                previewBox.className = 'fas ' + (iconClass || 'fa-check');
            }
        }

        function loadAboutUsContent() {
            fetch('settings_action.php?action=fetch_about_us')
                .then(res => res.json())
                .then(data => {
                    if (data.status === 'success') {
                        const d = data.data;

                        // 🟢 MERGE LOGIC: Combine Paragraph 1 and 2 if both exist
                        const p1 = d['gem_p1'] || '';
                        const p2 = d['gem_p2'] || '';

                        // Populate basic fields
                        const basicFields = ['gem_title', 'gem_p1', 'gem_p2', 'sig_title', 'sig_relax_h3', 'sig_relax_p', 'sig_dining_h3', 'sig_dining_p', 'visit_address', 'sig_relax_img', 'sig_dining_img'];
                        basicFields.forEach(key => {
                            const el = document.getElementById('about_' + key);
                            if (el) {
                                if (key === 'gem_p1') {
                                    el.value = p1 + (p2 ? '\n\n' + p2 : '');
                                } else if (key === 'gem_p2') {
                                    el.value = ''; // Reset hidden field so it gets cleared in DB on next save
                                } else {
                                    el.value = d[key] || '';
                                }
                                // 🟢 TRIGGER WORD COUNT FOR TEXTAREAS
                                if (el.tagName === 'TEXTAREA') updateWordCount(el);
                            }
                        });

                        // Set Image Previews
                        if (d.sig_relax_img) {
                            document.getElementById('prev_sig_relax_img').src = d.sig_relax_img.startsWith('../../') ? d.sig_relax_img : '../../room_includes/uploads/about/' + d.sig_relax_img;
                        }
                        if (d.sig_dining_img) {
                            document.getElementById('prev_sig_dining_img').src = d.sig_dining_img.startsWith('../../') ? d.sig_dining_img : '../../room_includes/uploads/about/' + d.sig_dining_img;
                        }

                        // Populate Dynamic Lists
                        document.getElementById('services-list-admin').innerHTML = '';
                        document.getElementById('features-list-admin').innerHTML = '';

                        if (d.hotel_services) {
                            d.hotel_services.split('\n').forEach(line => {
                                const parts = line.split('|');
                                if (parts.length === 2) addAboutListItem('services', parts[0].trim(), parts[1].trim());
                            });
                        }
                        if (d.room_features) {
                            d.room_features.split('\n').forEach(line => {
                                const parts = line.split('|');
                                if (parts.length === 2) addAboutListItem('features', parts[0].trim(), parts[1].trim());
                            });
                        }
                    }
                })
        ...
        function saveAboutUsContent(e) {
            ...
            const serializeList = (containerId) => {
                const container = document.getElementById(containerId);
                const items = container.querySelectorAll('.about-list-item');
                let result = [];
                items.forEach(item => {
                    const icon = item.querySelector('.item-icon').value.trim();
                    const label = item.querySelector('.item-label').value.trim();
                    if (icon && label) result.push(`${icon}|${label}`);
                });
                return result.join('\n');
            };

            const hotelServices = serializeList('services-list-admin');
            const roomFeatures = serializeList('features-list-admin');

            const formData = new FormData(e.target);
            const payload = new FormData();
            payload.append('action', 'save_about_us');
            payload.append('csrf_token', csrfToken);

            // Basic Fields
            formData.forEach((value, key) => {
                if (key !== 'hotel_services' && key !== 'room_features') {
                    payload.append(`contents[${key}]`, value);
                }
            });

            // Add serialized lists
            payload.append('contents[hotel_services]', hotelServices);
            payload.append('contents[room_features]', roomFeatures);
        ...
        // Attach to menu click
        document.addEventListener("DOMContentLoaded", function() {
            const aboutUsCard = document.querySelector('.tree-item-card[onclick*="view-about-us"]');
            if (aboutUsCard) {
                aboutUsCard.addEventListener('click', loadAboutUsContent);
            }
        });
    </script>
