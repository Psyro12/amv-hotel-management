...
<head>
    ...
    <style>
        ...
        #initialDashboardLoader.hidden {
            opacity: 0;
            visibility: hidden;
            pointer-events: none;
        }

        #initialDashboardLoader .loader-container {
            text-align: center;
            animation: fadeIn 0.5s ease-in-out;
        }

        #initialDashboardLoader h3 {
            margin-top: 30px;
            color: #333;
            font-weight: 600;
            font-size: 1.2rem;
        ...
        /* 🟢 CUSTOM PREMIUM SYSTEM LOADER (AMV Style) */
        .amv-loader-container {
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center;
        ...
        .amv-loader {
            width: 50px;
            height: 50px;
            border: 3px solid rgba(184, 142, 47, 0.1);
            border-top: 3px solid #B88E2F;
            border-radius: 50%;
            animation: amv-spin 1s cubic-bezier(0.4, 0, 0.2, 1) infinite;
            position: relative;
            display: inline-block;
        }
        ...
        .amv-loader::after {
            ...
            right: 5px;
            bottom: 5px;
            border: 2px solid rgba(184, 142, 47, 0.05);
            border-top: 2px solid #D4C85B;
            border-radius: 50%;
            animation: amv-spin 1.5s linear infinite;
        }
        ...
        .amv-loader-sm {
            ...
            border-radius: 50%;
            animation: amv-spin 0.8s linear infinite;
            display: inline-block;
            vertical-align: middle;
            margin-right: 8px;
        }
...
<body>
    ...
    `;
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // 🟢 TABLE LOAD TRACKERS (Prevents repeated spinners when switching tabs)
            ...
            document.querySelectorAll('.nav-menu .nav-item').forEach(link => {
                link.onclick = function (e) {
                    ...
                    // 🟢 Refresh data for the specific page being opened (Only first load is non-silent)
    ...
    `;
        ...
        function loadTransactions(isSilent = false) {
            ...
            if (!isSilent && tbody) {
                tbody.innerHTML = `<tr><td colspan="8" style="padding: 100px 0; text-align: center;">
                    <div class="amv-loader-container">
                        <div class="amv-loader"></div>
                        <div style="font-weight: 600; font-size: 1.1rem; letter-spacing: 0.5px; color: #B88E2F;">Loading Transactions...</div>
                    </div>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // 🟢 HIDE THE INITIAL DASHBOARD LOADER
