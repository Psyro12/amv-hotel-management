            ...
            <div class="gallery-wrapper">
                ...
                <div class="gallery-viewport">
                    <div class="room-gallery-track" id="track">
                        ...
                        // 2. Fetch Rooms
                        $query = "SELECT name AS image_name, description, image_path AS file_path, amenities, bed_type FROM rooms WHERE is_active = 1 ORDER BY name ASC";
        ...
        <section class="mobile-app-promo">
            <div class="app-promo-content reveal-from-left">
                ...
                <div class="app-download-btns">
                    <a href="https://drive.google.com/file/d/1183cWRe91oqzqKtu_fovzNI_qqCcTr6b/view?usp=sharing" target="_blank" class="btn-app-download">
