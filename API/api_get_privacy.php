...
$sql = "SELECT section_title, content FROM privacy_policy ORDER BY display_order ASC";
...
if ($result) {
    ...
    error_log("Database Error (Privacy): " . $conn->error);
